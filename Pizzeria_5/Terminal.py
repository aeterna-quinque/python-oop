from Pizzeria_5.Menu.Barbecue import Barbecue
from Pizzeria_5.Menu.Seafood import Seafood
from Pizzeria_5.Menu.Pepperoni import Pepperoni
from Pizzeria_5.Order import Order
from Pizzeria_5.Pizza import Pizza
from Pizzeria_5.PizzaFound import PizzaFound
from Pizzeria_5.CookingThread import CookingThread
...
class Terminal:
    ...
    def cook_order(self):
        ...
        Из списка пицц заказа берет каждую пиццу, создает для нее поток и запускает его.
